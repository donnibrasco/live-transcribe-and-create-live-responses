...
echo ""
echo "📊 What's Running:"
echo "  🎤 Main Server: http://$(hostname -I | awk '{print $1}'):8000"
echo "  🔄 Restart Service: http://$(hostname -I | awk '{print $1}'):8001"
...
echo "  Overlay: http://$(hostname -I | awk '{print $1}'):8000/overlay"
echo "  Health: http://$(hostname -I | awk '{print $1}'):8000/health"
echo "  Restart: curl -X POST http://$(hostname -I | awk '{print $1}'):8001/restart"
